      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          ...
          <p className="py-2 text-gray-600">
            ...
            specializes in Javascript based in New York City. I'm passionate
            about developing scalable, impactful solutions to real-world
            problems.
          </p>
          <p className="py-2 text-gray-600">
            ...
            learning, led me to enroll and complete Fullstack Academy's Software
            Engineering Immersive Program, where I successfully built a solid
            foundation for full stack development. I'm excited to be a part of
            an industry where creativity and innovation collide to create
            practical solutions that are genuinely useful and enjoyable.
          </p>
          <p className="py-2 text-gray-600">
            When I'm not working on software-related projects or coding, you can
            find me jogging or going on coffee runs with my Goldendoodle, Nori.
          </p>
        </div>
