    ...
    <div id='projects' className='w-full'>
      <div className='max-w-[1240px] mx-auto px-2 py-16'>
        ...
        <div className='grid md:grid-cols-1 gap-8'>
          <SingleProj
            title='Doodle & Co'
            description='Fullstack e-commerce application using Nextjs'
            backgroundImg={doodleImg}
            projectUrl='https://doodleco.vercel.app/'
            githubUrl='https://github.com/vidafeng/doodle-and-co'
            moreInfo='/doodleco'
          />
          <SingleProj
            title='Delicio'
